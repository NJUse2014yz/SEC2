...
public class DeliverReceipt implements ReceiptService {
	...
	public ResultMessage approve(ReceiptVO vo) {
		...
		CollectionRecordPO record = new CollectionRecordPO(info.getBarId(), receipt.getMakeTime(), info.getCostForAll(),
				deliverId, positionId);
		CollectionRecord recordService = new CollectionRecord();
	...
	/*
	 * public static void main(String[] args) { DeliverReceipt receipt=new
	 * DeliverReceipt(); System.out.println(receipt.calculateCost(900, "1",
	 * DeliveryType.FAST)); System.out.println(receipt.isBarId("1234567890"));
